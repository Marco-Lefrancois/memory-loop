...
- ✅ **Always do (Toujours Faire)** :
  ...
  - **Standard Grill-with-Docs & Dossier de Preuves Documentaires (Passage-Level Grounding Inconditionnel - ADR-0320 / ADR-0326)** : Obligation formelle de produire et restituer le **Dossier de Preuves Documentaires & Faits Établis** complet (1. Maquettes SSOT & Notes d'Atelier avec liens `file:///...`, 2. Extraits verbatim sourcés avec numéros de lignes précis et faits établis déduits `Extrait N — Titre (Lignes X-Y) : « Citation » ➔ Fait établi : ...`, 3. Structure de données DBML) pour TOUT récit, **qu'une session de grill ait lieu ou non**, avant de poser une question d'arbitrage ou d'entamer la rédaction formelle du récit.
