...
| :--: | :----------------- | :------: | :--------------------- | :----------------------------------------------------------------------------------- | :-------: | :---------------- | :----------------------------------------- |
| [x]  | **MLOOP-330-BE**   |    -     | Standards/Blueprints   | Normalisation des Gabarits de Traçabilité Code ↔ Exigences & Schéma EvidencePack 2.0 | `✅ DONE`  | 🟢 `DONE_TESTED`  | ✅ Sentinel PASS (2026-09-25) · Trust 83.2  |
| [x]  | **MLOOP-331-BE**   |    -     | Core/AST               | Moteur d'Extraction AST & Résolution Déterministe des Symboles de Code               | `✅ DONE`  | 🟢 `DONE_TESTED`  | ✅ Sentinel PASS (2026-09-25) · Trust 83.2  |
| [x]  | **MLOOP-332-BE**   |    -     | Pipelines/EvidencePack | Pipeline d'Harmonisation Synchrone EvidencePack 2.0 & Archivage des Preuves          | `✅ DONE`  | 🟢 `DONE_TESTED`  | ✅ Sentinel PASS (2026-09-25) · Auto-SDLC   |
| [ ]  | **MLOOP-333-BE**   |    -     | QA/VibeCheck           | Sonde Vibe-Check Check 29 (Intégrité Traçabilité Code ↔ Exigences) & Commande CLI    | `✅ DONE`  | 🟢 `READY_FOR_DEV` | 👤 PO Marco (Gate 2 validée le 25/09/2026) |
| [ ]  | **MLOOP-334-FULL** |    -     | Tests/Traceability     | Harnais de Validation Intégrale, Tests de Non-Régression & Parité Documentaire       | `✅ DONE`  | 🟢 `READY_FOR_DEV` | 👤 PO Marco (Gate 2 validée le 25/09/2026) |
...
| État | Récit | Clé Jira | Composant | Titre | Grill-me | Statut | Responsable |
| :---: | :--- | :---: | :--- | :--- | :---: | :--- | :--- |
| [x] | **MLOOP-340-BE** | - | Core/Memory | Schéma Relationnel & Persistance SQLite du Wiki Graph Dual-Layer ($\mathcal{E}_w, \mathcal{R}_w, \mathcal{D}$) | `✅ DONE` | 🟢 `DONE_TESTED` | ✅ Sentinel PASS (2026-09-25) |
| [x] | **MLOOP-341-BE** | - | Pipelines/Ingest | Moteur d'Ingestion & Indexation Dual-Space (Passages Denses, Entités Métier & Hyper-Arêtes) | `✅ DONE` | 🟢 `DONE_TESTED` | ✅ Sentinel PASS (2026-09-25) |
| [x] | **MLOOP-342-BE** | - | Search/Reflection | Boucle de Fact-Search Réflexif à Budget Borné ($B \le 3$) & Arrêt Anticipé Adaptatif | `✅ DONE` | 🟢 `DONE_TESTED` | ✅ Sentinel PASS (2026-09-25) · 5/5 Tests PASS |
| [x] | **MLOOP-343-BE** | - | QA/Grounding | Mode Reject Souverain Anti-Hallucination & Régularisation de Variance de Scoring | `✅ DONE` | 🟡 `READY_FOR_QA` | ✅ Sentinel PASS (2026-09-25) · 8/8 Tests PASS |
...
| État | Récit | Clé Jira | Composant | Titre | Grill-me | Statut | Responsable |
| :---: | :--- | :---: | :--- | :--- | :---: | :--- | :--- |
| [x] | **MLOOP-350-BE** | - | Audit/Objects | Moteur d'Audit Déterministe d'Arbre d'Objets Natifs pour Livrables d'Architecture | `✅ DONE` | 🟡 `READY_FOR_QA` | ✅ Sentinel PASS (2026-09-25) |
| [x] | **MLOOP-351-BE** | - | Audit/Scoring | Grille d'Audit Découplée 5-Axes Pénétrante ($T_{20} + S_{30} + L_{15} + E_{25} + V_{10}$) | `✅ DONE` | 🟡 `READY_FOR_QA` | ✅ Sentinel PASS (2026-09-25) |
| [x] | **MLOOP-352-BE** | - | Linter/Causality | Linter Matriciel d'Inversion Causale par Comparaison d'Adjacence ($\mathbf{A}_{\text{spec}} \text{ vs } \mathbf{A}_{\text{diag}}$) | `✅ DONE` | 🟢 `DONE_TESTED` | ✅ Sentinel PASS (2026-09-25) · 9/9 Tests PASS |
| [x] | **MLOOP-353-BE** | - | Handoff/Harness | Adaptateur de Dev Handoff Multi-Harnais Dédié (Claude Code, OpenCode, Codex & Cursor) | `✅ DONE` | 🟡 `READY_FOR_QA` | ✅ Sentinel PASS (2026-09-25) · 8/8 Tests PASS |
...
| [x] | **MLOOP-390-BE** | - | Commands/Sync | Migration & Synchronisation Idempotente des Permissions `opencode.json` Multi-Projets | `✅ DONE` | 🟡 `READY_FOR_QA` | ✅ Sentinel PASS (2026-09-25) |
| [x] | **MLOOP-391-BE** | - | Pipelines/VibeCheck | Sonde Vibe-Check Check 31 : Audit Dynamique de Santé des Permissions & Runtimes Workers | `✅ DONE` | 🟡 `READY_FOR_QA` | ✅ Sentinel PASS (2026-09-25) |
| [x] | **MLOOP-392-BE** | - | Core/WorkerRuntimes | Extension Multi-Runtimes Déclarative Herdr (Claude Code, Gemini CLI, Cursor CLI, Codex) | `✅ DONE` | 🟡 `READY_FOR_QA` | ✅ Sentinel PASS (2026-09-25) |

---

## Épopée : EPIC-37-PHASE5-SHIP-AUTOMATION-CHANGELOG-AND-SINGLE-REPO-GUARD (Automatisation Déterministe du CHANGELOG en Phase 5, Verrou Anti-Sous-Dépôt & Intégrité du Dépôt Unique) [OPEN]

> 📦 **Origine** : Cadrage formel du 25/09/2026 suite au constat d'angle mort lors de la release Phase 3. Absence de moteur automatisé de synchronisation de `CHANGELOG.md` générant une dette documentaire de plusieurs versions, et présence d'un sous-dépôt `.git` vestigial dans `Projects/mLoop` ayant injecté des branches parasites sur GitHub (`master`, `project-mLoop`). Références : ADR-0397, ADR-0375, ADR-0391, ADR-0370, ADR-0376, `github-ops/SKILL.md`. Backlog détaillé : [`epics/epic_phase5_ship_automation_changelog_single_repo_guard.md`](epics/epic_phase5_ship_automation_changelog_single_repo_guard.md). Récits Palier 1 (`status: DRAFT` / `grill_me: PENDING`).

| État | Récit | Clé Jira | Composant | Titre | Grill-me | Statut | Responsable |
| :---: | :--- | :---: | :--- | :--- | :---: | :--- | :--- |
| [ ] | **MLOOP-370-BE** | - | QA/VibeCheck | Sonde Vibe-Check Check 32 (Garde-Fou Déterministe Dépôt Unique & Anti-Sous-Dépôt) | `✅ DONE` | 🟢 `READY_FOR_DEV` | 👤 Humain (Gate 2 Marco, 2026-09-25) |
| [ ] | **MLOOP-371-BE** | - | Pipelines/Changelog | Moteur de Compilation & Déduplication Automatique du CHANGELOG (`changelog_engine.py`) | `PENDING` | ⚪ `DRAFT` | ⚪ À faire |
| [ ] | **MLOOP-372-BE** | - | Commands/Changelog | Commandes CLI `changelog-sync` et `changelog-check` (`handlers/changelog.py`) | `PENDING` | ⚪ `DRAFT` | ⚪ À faire |
| [ ] | **MLOOP-373-BE** | - | QA/VibeCheck | Sonde Vibe-Check Check 33 (Validation Déterministe de Fraîcheur du CHANGELOG en Phase 5) | `PENDING` | ⚪ `DRAFT` | ⚪ À faire |
| [ ] | **MLOOP-374-FULL** | - | Core/Integration | Auto-Clôture Gate 5, Tests E2E Hermétiques & Synchronisation SSOT Guide CLI | `PENDING` | ⚪ `DRAFT` | ⚪ À faire |
