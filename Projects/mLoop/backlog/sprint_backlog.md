...
| :---: | :--- | :---: | :--- | :--- | :---: | :--- | :--- |
| [x] | **MLOOP-330-BE** | - | Standards/Blueprints | Normalisation des Gabarits de Traçabilité Code ↔ Exigences & Schéma EvidencePack 2.0 | `✅ DONE` | 🟢 `READY_FOR_DEV` | ✅ Sentinel PASS (2026-09-25) · Trust 83.2 |
| [x] | **MLOOP-331-BE** | - | Core/AST | Moteur d'Extraction AST & Résolution Déterministe des Symboles de Code | `✅ DONE` | 🟢 `READY_FOR_DEV` | ✅ Sentinel PASS (2026-09-25) · Trust 83.2 |
...
| [ ] | **MLOOP-341-BE** | - | Pipelines/Ingest | Moteur d'Ingestion & Indexation Dual-Space (Passages Denses, Entités Métier & Hyper-Arêtes) | `✅ DONE` | 🟡 `READY_FOR_GROOMING` | 🤖 IA (DoR 6/6 certifié - En attente Gate 2 Marco) |
