...
def run_ingest(project_name: str, state: LoopState, project_path: Path):
    ...
    ZeroFluffConsole.info(f"📊 [Source Manifest] {total_sources} source(s) consolidée(s) | {total_sections} sections répertoriées | {total_terms} termes extraits")
