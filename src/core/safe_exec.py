...
def safe_run_entrypoint(main_func):
    ...
    try:
        ...
        if "StateTransitionError" in err_name or "VIOLATION" in err_msg or "VERROU" in err_msg:
            ...
            print("   2. Ajustez l'attention du récit actif avec 'python src/swarm.py focus --project <projet> --story <chemin>'.")
        
        # Exit propre 0 pour ne pas détruire la session OpenCode Sidecar
        sys.exit(0)
